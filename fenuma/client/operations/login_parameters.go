...
type LoginParams struct {
	...
	/* ModelsLoginReq.
	   ...
	   LoginReq
	*/
	ModelsLoginReq *models.ModelsLoginReq
...
// WithModelsLoginReq adds the modelsLoginReq to the login params
func (o *LoginParams) WithModelsLoginReq(modelsLoginReq *models.ModelsLoginReq) *LoginParams {
	o.SetModelsLoginReq(modelsLoginReq)
	return o
}

// SetModelsLoginReq adds the modelsLoginReq to the login params
func (o *LoginParams) SetModelsLoginReq(modelsLoginReq *models.ModelsLoginReq) {
	o.ModelsLoginReq = modelsLoginReq
}
...
func (o *LoginParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.ModelsLoginReq != nil {
		if err := r.SetBodyParam(o.ModelsLoginReq); err != nil {
			return err
		}
	}
