...
func (o *LoginOK) GetPayload() *models.ModelsResponse {
	return o.Payload
}
...
func (o *LoginBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/login][%d] loginBadRequest  %+v", 400, o.Payload)
}
func (o *LoginBadRequest) GetPayload() *models.ModelsResponse {
	return o.Payload
}
