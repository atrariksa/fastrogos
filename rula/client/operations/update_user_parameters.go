...
type UpdateUserParams struct {
	...
	/* ModelsUpdateUserReq.
	   ...
	   UpdateUserReq
	*/
	ModelsUpdateUserReq *models.ModelsUpdateUserReq
...
// WithModelsUpdateUserReq adds the modelsUpdateUserReq to the update user params
func (o *UpdateUserParams) WithModelsUpdateUserReq(modelsUpdateUserReq *models.ModelsUpdateUserReq) *UpdateUserParams {
	o.SetModelsUpdateUserReq(modelsUpdateUserReq)
	return o
}

// SetModelsUpdateUserReq adds the modelsUpdateUserReq to the update user params
func (o *UpdateUserParams) SetModelsUpdateUserReq(modelsUpdateUserReq *models.ModelsUpdateUserReq) {
	o.ModelsUpdateUserReq = modelsUpdateUserReq
}
...
func (o *UpdateUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.ModelsUpdateUserReq != nil {
		if err := r.SetBodyParam(o.ModelsUpdateUserReq); err != nil {
			return err
		}
	}
