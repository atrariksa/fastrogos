...
func (o *UpdateUserOK) GetPayload() *models.ModelsResponse {
	return o.Payload
}
...
func (o *UpdateUserBadRequest) Error() string {
	return fmt.Sprintf("[PUT /user/][%d] updateUserBadRequest  %+v", 400, o.Payload)
}
func (o *UpdateUserBadRequest) GetPayload() *models.ModelsResponse {
	return o.Payload
}
