...
type DeleteUserParams struct {
	...
	/* ModelsDeleteUserReq.
	   ...
	   DeleteUserReq
	*/
	ModelsDeleteUserReq *models.ModelsDeleteUserReq
...
// WithModelsDeleteUserReq adds the modelsDeleteUserReq to the delete user params
func (o *DeleteUserParams) WithModelsDeleteUserReq(modelsDeleteUserReq *models.ModelsDeleteUserReq) *DeleteUserParams {
	o.SetModelsDeleteUserReq(modelsDeleteUserReq)
	return o
}

// SetModelsDeleteUserReq adds the modelsDeleteUserReq to the delete user params
func (o *DeleteUserParams) SetModelsDeleteUserReq(modelsDeleteUserReq *models.ModelsDeleteUserReq) {
	o.ModelsDeleteUserReq = modelsDeleteUserReq
}
...
func (o *DeleteUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.ModelsDeleteUserReq != nil {
		if err := r.SetBodyParam(o.ModelsDeleteUserReq); err != nil {
			return err
		}
	}
